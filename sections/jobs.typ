...
#section("EXPERIENCE")
  ...
  [
    - Develop the network diagnostics agent shipped on telecom operator gateways: raw-socket ICMP, TWAMP, throughput and HTTP browsing probes reporting over MQTT
    ...
    - Ported the agent and its three kernel modules onto seven OEM gateway platforms across prplOS, OpenWrt and buildroot — ARMv7 and aarch64, musl and glibc, kernels up to 5.4, GCC 5.5 to 7.5
